        ...
        <header id="header" class="header-v3">
            <nav class="flat-mega-menu">
                ...
                <ul class="collapse">
                    ...
                    <li> <a href="{{ route('servicecategories') }}">Service Categories</a></li>
                    ...
                    <li class="login-form"> <a href="#" title="Register">My Account (SVP)</a>
                        <ul class="drop-down one-column hover-fade">
                            <li><a href="{{ route('serviceprovider.dashboard') }}">Dashboard</a></li>
                            <li><a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
                            </li>
                        </ul>
                    </li>
                ...
                <div class="row visible-md visible-lg">
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        ...
                        <ul>
                            ...
                            <li><i class="fa fa-check"></i> <a href="servicesbycategory/13.html">Refrigerator</a>
                            </li>
                    ...
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        ...
                        <ul>
                            ...
                            <li><i class="fa fa-check"></i> <a href="servicesbycategory/8.html">Pest Control </a>
                            </li>
