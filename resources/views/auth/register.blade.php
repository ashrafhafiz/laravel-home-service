                ...
                <x-jet-label for="terms">
                    <div class="flex items-center">
                        ...
                        <div class="ml-2">
                            ...
                            'terms_of_service' =>
                            '<a target="_blank" href="'.route('terms.show').'" class="underline text-sm text-gray-600 hover:text-gray-900">'.__('Terms of Service').'</a>',
                            'privacy_policy' =>
                            '<a target="_blank" href="'.route('policy.show').'" class="underline text-sm text-gray-600 hover:text-gray-900">'.__('Privacy Policy').'</a>',
                            ]) !!}
                        </div>
                    </div>
                </x-jet-label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select name="utype" id="utype" class="form-control">
                                            ...
                                            <option value="CST" @if(old('utype')=='CST' ) selected @endif>Customer
                                            </option>
                                            <option value="SVP" @if(old('utype')=='SVP' ) selected @endif>Service
                                                Provider</option>
                                        </select>
                                    </div>
                                </div>
